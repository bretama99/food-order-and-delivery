...
class FoodItemOptionMenuPopup extends StatefulWidget{
  Function onSelect;
  static _OrderOptionMenuesAction ACTIONS = _OrderOptionMenuesAction();
  FoodItemsModel foodItemsModel;
  FoodItemOptionMenuPopup({required this.onSelect, required this.foodItemsModel}){

  }
  @override
  State<StatefulWidget> createState() => _OptionMenuState();
}
class _OptionMenuState extends MountedState<FoodItemOptionMenuPopup>{
  @override
                    ...
                    Transform.translate(
                      ...
                      child: Column(
                        children: [
                          ...
                          OptionMenuTile(SvgPicture.asset(AppImages.deleteIcon, height: 30,color: Colors.black,),Colors.white,widget.foodItemsModel.isActivated?"DEACTIVATE":"ACTIVATE" ,(){
                            Navigator.pop(context);
                            widget.onSelect(FoodItemOptionMenuPopup.ACTIONS.ACTION_ACTIVATE_DEACTIVATE);
                          }),
